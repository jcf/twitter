...
describe Nunemaker::Twitter::RateLimit do

  describe "#limit" do
    it "returns an Integer when x-rate-limit-limit header is set" do
      rate_limit = Nunemaker::Twitter::RateLimit.new("x-rate-limit-limit" => "150")
    ...
    it "returns nil when x-rate-limit-limit header is not set" do
      rate_limit = Nunemaker::Twitter::RateLimit.new
  ...
  describe "#remaining" do
    it "returns an Integer when x-rate-limit-remaining header is set" do
      rate_limit = Nunemaker::Twitter::RateLimit.new("x-rate-limit-remaining" => "149")
  ...
  describe "#reset_at" do
    it "returns a Time when x-rate-limit-reset header is set" do
      rate_limit = Nunemaker::Twitter::RateLimit.new("x-rate-limit-reset" => "1339019097")
