...
describe Nunemaker::Twitter::API::Search do
  ...
  describe "#search" do
    ...
    it "returns recent Tweets related to a query with images and videos embedded" do
      ...
      expect(search).to be_a Nunemaker::Twitter::SearchResults
      expect(search.results).to be_an Array
      expect(search.results.first).to be_a Nunemaker::Twitter::Tweet
