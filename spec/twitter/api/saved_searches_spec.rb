...
describe Nunemaker::Twitter::API::SavedSearches do
  ...
  describe "#saved_searches" do
    context "with ids passed" do
      ...
      it "returns an array of saved searches" do
        ...
        expect(saved_searches.first).to be_a Nunemaker::Twitter::SavedSearch
  ...
  describe "#saved_search" do
    ...
    it "returns a saved search" do
      ...
      expect(saved_search).to be_a Nunemaker::Twitter::SavedSearch
