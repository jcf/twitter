...
describe Nunemaker::Twitter::API::Users do
  ...
  describe "#settings" do
    ...
    it "returns settings" do
      ...
      expect(settings).to be_a Nunemaker::Twitter::Settings
  ...
  describe "#suggestions" do
    context "with a category slug passed" do
      ...
      it "returns the users in a given category of the Nunemaker::Twitter suggested user list" do
        suggestion = @client.suggestions("art-design")
        expect(suggestion).to be_a Nunemaker::Twitter::Suggestion
        expect(suggestion.name).to eq "Art & Design"
        expect(suggestion.users).to be_an Array
        expect(suggestion.users.first).to be_a Nunemaker::Twitter::User
      end
    end
    context "without arguments passed" do
      ...
      it "returns the list of suggested user categories" do
        ...
        expect(suggestions.first).to be_a Nunemaker::Twitter::Suggestion
  ...
  describe "#suggest_users" do
    ...
    it "returns users in a given category of the Nunemaker::Twitter suggested user list and return their most recent status if they are not a protected user" do
      suggest_users = @client.suggest_users("art-design")
      expect(suggest_users).to be_an Array
      expect(suggest_users.first).to be_a Nunemaker::Twitter::User
  ...
  describe "#blocking" do
    ...
    it "returns an array of user objects that the authenticating user is blocking" do
      ...
      expect(blocking).to be_a Nunemaker::Twitter::Cursor
      expect(blocking.users).to be_an Array
      expect(blocking.users.first).to be_a Nunemaker::Twitter::User
  ...
  describe "#blocked_ids" do
    ...
    it "returns an array of numeric user IDs the authenticating user is blocking" do
      ...
      expect(blocked_ids).to be_a Nunemaker::Twitter::Cursor
  ...
  describe "#block" do
    ...
    it "returns an array of blocked users" do
      ...
      expect(users.first).to be_a Nunemaker::Twitter::User
  ...
  describe "#users" do
    context "using a post request" do
      ...
      context "with user objects passed" do
        ...
        it "requests the correct resource" do
          user1 = Nunemaker::Twitter::User.new(:id => "7505382")
          user2 = Nunemaker::Twitter::User.new(:id => "14100886")
  ...
  describe "#user_search" do
    ...
    it "returns an array of user search results" do
      ...
      expect(user_search.first).to be_a Nunemaker::Twitter::User
  ...
  describe "#contributees" do
    context "with a screen name passed" do
      ...
      it "returns a user's contributees" do
        ...
        expect(contributees.first).to be_a Nunemaker::Twitter::User
        expect(contributees.first.name).to eq "Nunemaker::Twitter API"
      end
    end
    context "with a user ID passed" do
      before do
  ...
  describe "#contributors" do
    context "with a screen name passed" do
      ...
      it "returns a user's contributors" do
        ...
        expect(contributors.first).to be_a Nunemaker::Twitter::User
  ...
  describe "#profile_banner" do
    context "with a screen_name passed" do
      ...
      it "returns a user's profile banner" do
        ...
        expect(banner).to be_a Nunemaker::Twitter::ProfileBanner
