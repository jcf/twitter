...
describe Nunemaker::Twitter::API::Tweets do
  ...
  describe "#retweets" do
    ...
    context "with a Tweet passed" do
      it "requests the correct resource" do
        tweet = Nunemaker::Twitter::Tweet.new(:id => 25938088801)
        @client.retweets(tweet)
        expect(a_get("/1.1/statuses/retweets/25938088801.json")).to have_been_made
      end
    end
  ...
  describe "#retweet!" do
    ...
    context "fobidden" do
      ...
      it "raises a Forbidden error" do
        expect{@client.retweet!(25938088801)}.to raise_error Nunemaker::Twitter::Error::Forbidden
      end
    end
    context "already retweeted" do
      before do
      ...
      it "raises an AlreadyRetweeted error" do
        expect{@client.retweet!(25938088801)}.to raise_error Nunemaker::Twitter::Error::AlreadyRetweeted
      end
    end
    context "with a URI object passed" do
      it "requests the correct resource" do
  ...
  describe "#oembed" do
    ...
    it "returns an array of OEmbed instances" do
      ...
      expect(oembed).to be_a Nunemaker::Twitter::OEmbed
    end
    context "with a URI object passed" do
      it "requests the correct resource" do
        tweet = URI.parse("https://twitter.com/sferik/status/25938088801")
  ...
  describe "#oembeds" do
    ...
    it "returns an array of OEmbed instances" do
      ...
      expect(oembeds.first).to be_a Nunemaker::Twitter::OEmbed
    end
    context "with a URI object passed" do
      it "requests the correct resource" do
        tweet = URI.parse("https://twitter.com/sferik/status/25938088801")
  ...
  describe "#retweeters_ids" do
    ...
    it "returns a collection of up to 100 user IDs belonging to users who have retweeted the tweet specified by the id parameter" do
      ...
      expect(retweeters_ids).to be_a Nunemaker::Twitter::Cursor
