...
describe Nunemaker::Twitter::User do

  describe "#==" do
    it "returns true when objects IDs are the same" do
      user = Nunemaker::Twitter::User.new(:id => 1, :screen_name => "foo")
      other = Nunemaker::Twitter::User.new(:id => 1, :screen_name => "bar")
      expect(user == other).to be_true
    end
    it "returns false when objects IDs are different" do
      user = Nunemaker::Twitter::User.new(:id => 1)
      other = Nunemaker::Twitter::User.new(:id => 2)
  ...
  describe "#created_at" do
    it "returns a Time when created_at is set" do
      user = Nunemaker::Twitter::User.new(:id => 7505382, :created_at => "Mon Jul 16 12:59:01 +0000 2007")
      expect(user.created_at).to be_a Time
    end
    it "returns nil when created_at is not set" do
      user = Nunemaker::Twitter::User.new(:id => 7505382)
  ...
  describe "#description_urls" do
    it "returns an Array of Entity::Url" do
      ...
      description_urls = Nunemaker::Twitter::User.new(:id => 7505382, :entities => {:description => {:urls => urls_array}}).description_urls
      expect(description_urls).to be_an Array
      expect(description_urls.first).to be_a Nunemaker::Twitter::Entity::Url
    ...
    it "is empty when not set" do
      description_urls = Nunemaker::Twitter::User.new(:id => 7505382, :entities => {:description => {:urls => []}}).description_urls
  ...
  describe "#profile_banner_url" do
    it "returns a String when profile_banner_url is set" do
      user = Nunemaker::Twitter::User.new(:id => 7505382, :profile_banner_url => "https://si0.twimg.com/profile_banners/7505382/1348266581")
  ...
  describe "#profile_banner_url?" do
    it "returns true when profile_banner_url is set" do
      profile_banner_url = Nunemaker::Twitter::User.new(:id => 7505382, :profile_banner_url => "https://si0.twimg.com/profile_banners/7505382/1348266581").profile_banner_url?
      expect(profile_banner_url).to be_true
    end
    it "returns false when status is not set" do
      profile_banner_url = Nunemaker::Twitter::User.new(:id => 7505382).profile_banner_url?
  ...
  describe "#profile_image_url" do
    it "returns a String when profile_image_url_https is set" do
      user = Nunemaker::Twitter::User.new(:id => 7505382, :profile_image_url_https => "https://a0.twimg.com/profile_images/1759857427/image1326743606_normal.png")
    ...
    context "with capitalized file extension" do
      it "returns the correct image" do
        user = Nunemaker::Twitter::User.new(:id => 7505382, :profile_image_url_https => "https://si0.twimg.com/profile_images/67759670/DSCN2136_normal.JPG")
  ...
  describe "#profile_image_url?" do
    it "returns true when profile_banner_url is set" do
      profile_image_url = Nunemaker::Twitter::User.new(:id => 7505382, :profile_image_url_https => "https://si0.twimg.com/profile_banners/7505382/1348266581").profile_image_url?
      expect(profile_image_url).to be_true
    end
    it "returns false when status is not set" do
      profile_image_url= Nunemaker::Twitter::User.new(:id => 7505382).profile_image_url?
  ...
  describe "#status" do
    it "returns a Status when status is set" do
      tweet = Nunemaker::Twitter::User.new(:id => 7505382, :status => {:id => 25938088801}).status
      expect(tweet).to be_a Nunemaker::Twitter::Tweet
    end
    it "returns nil when status is not set" do
      tweet = Nunemaker::Twitter::User.new(:id => 7505382).status
      expect(tweet).to be_nil
    end
    it "includes a User when user is set" do
      tweet = Nunemaker::Twitter::User.new(:id => 7505382, :screen_name => "sferik", :status => {:id => 25938088801}).status
      expect(tweet.user).to be_a Nunemaker::Twitter::User
