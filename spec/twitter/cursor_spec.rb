...
describe Nunemaker::Twitter::Cursor do

  describe "#collection" do
    it "returns a collection" do
      collection = Nunemaker::Twitter::Cursor.new({:ids => [1, 2, 3, 4, 5]}, :ids, nil, Nunemaker::Twitter::Client.new, :follower_ids, {}).collection
  ...
  describe "#first?" do
    context "when previous cursor equals zero" do
      before do
        @cursor = Nunemaker::Twitter::Cursor.new({:previous_cursor => 0}, :ids, nil, Nunemaker::Twitter::Client.new, :follower_ids, {})
      end
      it "returns true" do
    ...
    context "when previous cursor does not equal zero" do
      before do
        @cursor = Nunemaker::Twitter::Cursor.new({:previous_cursor => 1}, :ids, nil, Nunemaker::Twitter::Client.new, :follower_ids, {})
      end
      it "returns true" do
  ...
  describe "#last?" do
    context "when next cursor equals zero" do
      before do
        @cursor = Nunemaker::Twitter::Cursor.new({:next_cursor => 0}, :ids, nil, Nunemaker::Twitter::Client.new, :follower_ids, {})
      end
      it "returns true" do
    ...
    context "when next cursor does not equal zero" do
      before do
        @cursor = Nunemaker::Twitter::Cursor.new({:next_cursor => 1}, :ids, nil, Nunemaker::Twitter::Client.new, :follower_ids, {})
      end
      it "returns false" do
