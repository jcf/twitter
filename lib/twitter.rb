...
module Nunemaker::Twitter
  ...
  class << self
    ...
    # Delegate to a Nunemaker::Twitter::Client
    ...
    def client
      ...
      @client = Nunemaker::Twitter::Client.new(options) unless defined?(@client) && @client.hash == options.hash
    ...
    # Has a client been initialized on the Nunemaker::Twitter module
