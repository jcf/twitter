...
module Nunemaker::Twitter
  module API
    module PlacesAndGeo
      ...
      # @param place_id [String] A place in the world. These IDs can be retrieved from {Nunemaker::Twitter::API::PlacesAndGeo#reverse_geocode}.
      # @param options [Hash] A customizable set of options.
      # @return [Nunemaker::Twitter::Place] The requested place.
      # @example Return all the information about Nunemaker::Twitter HQ
      #   Nunemaker::Twitter.place("247f43d441defc03")
      def place(place_id, options={})
        object_from_response(Nunemaker::Twitter::Place, :get, "/1.1/geo/id/#{place_id}.json", options)
      end
      ...
      #   Nunemaker::Twitter.reverse_geocode(:lat => "37.7821120598956", :long => "-122.400612831116")
      def reverse_geocode(options={})
        geo_objects_from_response(:get, "/1.1/geo/reverse_geocode.json", options)
      end

      # Search for places that can be attached to a {Nunemaker::Twitter::API::Tweets#update}
      #
      ...
      #   Nunemaker::Twitter.geo_search(:ip => "74.125.19.104")
      ...
      # @note Conceptually, you would use this method to get a list of known places to choose from first. Then, if the desired place doesn't exist, make a request to {Nunemaker::Twitter::API::PlacesAndGeo#place} to create a new one. The token contained in the response is the token necessary to create a new place.
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @param options [Hash] A customizable set of options.
      ...
      # @option options [String] :"attribute:street_address" This option searches for places which have this given street address. There are other well-known and application-specific attributes available. Custom attributes are also permitted.
      # @return [Array<Nunemaker::Twitter::Place>]
      # @example Return an array of places similar to Nunemaker::Twitter HQ
      #   Nunemaker::Twitter.similar_places(:lat => "37.7821120598956", :long => "-122.400612831116", :name => "Nunemaker::Twitter HQ")
      ...
      # @option options [String] :name The name a place is known as.
      # @option options [String] :contained_within This is the place_id which you would like to restrict the search results to. Setting this value means only places within the given place_id will be found.
      # @option options [String] :token The token found in the response from {Nunemaker::Twitter::API::PlacesAndGeo#places_similar}.
      # @option options [Float] :lat The latitude to search around. This option will be ignored unless it is inside the range -90.0 to +90.0 (North is positive) inclusive. It will also be ignored if there isn't a corresponding :long option.
      # @option options [Float] :long The longitude to search around. The valid range for longitude is -180.0 to +180.0 (East is positive) inclusive. This option will be ignored if outside that range, if it is not a number, if geo_enabled is disabled, or if there not a corresponding :lat option.
      # @option options [String] :"attribute:street_address" This option searches for places which have this given street address. There are other well-known and application-specific attributes available. Custom attributes are also permitted.
      # @return [Nunemaker::Twitter::Place] The created place.
      # @example Create a new place
      #   Nunemaker::Twitter.place_create(:name => "@sferik's Apartment", :token => "22ff5b1f7159032cf69218c4d8bb78bc", :contained_within => "41bcb736f84a799e", :lat => "37.783699", :long => "-122.393581")
      def place_create(options={})
        object_from_response(Nunemaker::Twitter::Place, :post, "/1.1/geo/place.json", options)
      end
    ...
    private
      ...
      def geo_objects_from_response(request_method, path, params={})
        objects_from_array(Nunemaker::Twitter::Place, send(request_method.to_sym, path, params)[:body][:result][:places])
      end
