...
module Nunemaker::Twitter
  module API
    module Timelines
      ...
      #   Nunemaker::Twitter.mentions
      def mentions_timeline(options={})
        objects_from_response(Nunemaker::Twitter::Tweet, :get, "/1.1/statuses/mentions_timeline.json", options)
      end
      ...
      def user_timeline(*args)
        objects_from_response_with_user(Nunemaker::Twitter::Tweet, :get, "/1.1/statuses/user_timeline.json", args)
      end
      ...
      #   Nunemaker::Twitter.retweeted_by_user('sferik')
      ...
      #   Nunemaker::Twitter.retweeted_by_me
      ...
      #   Nunemaker::Twitter.home_timeline
      def home_timeline(options={})
        objects_from_response(Nunemaker::Twitter::Tweet, :get, "/1.1/statuses/home_timeline.json", options)
      end
      ...
      #   Nunemaker::Twitter.retweeted_to_me
      ...
      #   Nunemaker::Twitter.retweets_of_me
      def retweets_of_me(options={})
        objects_from_response(Nunemaker::Twitter::Tweet, :get, "/1.1/statuses/retweets_of_me.json", options)
      end
