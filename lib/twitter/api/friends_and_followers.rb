...
module Nunemaker::Twitter
  module API
    module FriendsAndFollowers
      ...
      #     Nunemaker::Twitter.friend_ids('sferik')
      #     Nunemaker::Twitter.friend_ids(7505382)  # Same as above
      def friend_ids(*args)
      ...
      #     Nunemaker::Twitter.follower_ids
      ...
      #     Nunemaker::Twitter.follower_ids('sferik')
      #     Nunemaker::Twitter.follower_ids(7505382)  # Same as above
      ...
      #     Nunemaker::Twitter.friendships('sferik', 'pengwynn')
      #     Nunemaker::Twitter.friendships('sferik', 14100886)   # Same as above
      #     Nunemaker::Twitter.friendships(7505382, 14100886)    # Same as above
      ...
      def friendships(*args)
        ...
        objects_from_response(Nunemaker::Twitter::User, :get, "/1.1/friendships/lookup.json", arguments.options)
      end
      ...
      #   Nunemaker::Twitter.friendships_incoming
      ...
      #   Nunemaker::Twitter.friendships_outgoing
      ...
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<Nunemaker::Twitter::User>] The followed users.
      # @overload follow(*users)
      #   @param users [Enumerable<Integer, String, Nunemaker::Twitter::User>] A collection of Nunemaker::Twitter user IDs, screen names, or objects.
      #   @example Follow @sferik
      #     Nunemaker::Twitter.follow('sferik')
      ...
      def follow(*args)
        arguments = Nunemaker::Twitter::API::Arguments.new(args)
        # Nunemaker::Twitter always turns on notifications if the "follow" option is present, even if it's set to false
      ...
      def follow!(*args)
        ...
        arguments.flatten.threaded_map do |user|
          begin
            object_from_response(Nunemaker::Twitter::User, :post, "/1.1/friendships/create.json", merge_user(arguments.options, user))
          rescue Nunemaker::Twitter::Error::Forbidden
      ...
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<Nunemaker::Twitter::User>] The unfollowed users.
      # @overload unfollow(*users)
      #   @param users [Enumerable<Integer, String, Nunemaker::Twitter::User>] A collection of Nunemaker::Twitter user IDs, screen names, or objects.
      #   @example Unfollow @sferik
      #     Nunemaker::Twitter.unfollow('sferik')
      ...
      #   Nunemaker::Twitter.friendship_update('sferik', :device => true, :retweets => true)
      def friendship_update(user, options={})
        merge_user!(options, user)
        object_from_response(Nunemaker::Twitter::Relationship, :post, "/1.1/friendships/update.json", options)
      end
      ...
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Nunemaker::Twitter::Relationship]
      # @param source [Integer, String, Nunemaker::Twitter::User] The Nunemaker::Twitter user ID, screen name, or object of the source user.
      # @param target [Integer, String, Nunemaker::Twitter::User] The Nunemaker::Twitter user ID, screen name, or object of the target user.
      # @param options [Hash] A customizable set of options.
      # @example Return the relationship between @sferik and @pengwynn
      #   Nunemaker::Twitter.friendship('sferik', 'pengwynn')
      #   Nunemaker::Twitter.friendship('sferik', 14100886)   # Same as above
      #   Nunemaker::Twitter.friendship(7505382, 14100886)    # Same as above
      def friendship(source, target, options={})
        merge_user!(options, source, "source")
        options[:source_id] = options.delete(:source_user_id) unless options[:source_user_id].nil?
        merge_user!(options, target, "target")
        options[:target_id] = options.delete(:target_user_id) unless options[:target_user_id].nil?
        object_from_response(Nunemaker::Twitter::Relationship, :get, "/1.1/friendships/show.json", options)
      end
      ...
      #   Nunemaker::Twitter.followers('sferik')
      #   Nunemaker::Twitter.followers(7505382)    # Same as above
      def followers(*args)
        cursor_from_response_with_user(:users, Nunemaker::Twitter::User, :get, "/1.1/followers/list.json", args, :followers)
      end
      ...
      #   Nunemaker::Twitter.friends('sferik')
      #   Nunemaker::Twitter.friends(7505382)    # Same as above
      def friends(*args)
        cursor_from_response_with_user(:users, Nunemaker::Twitter::User, :get, "/1.1/friends/list.json", args, :friends)
      end
      ...
      #   Nunemaker::Twitter.no_retweet_ids
