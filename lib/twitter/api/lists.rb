...
module Nunemaker::Twitter
  module API
    module Lists
      ...
      #     Nunemaker::Twitter.lists('sferik')
      #     Nunemaker::Twitter.lists(7505382)
      def lists(*args)
        objects_from_response_with_user(Nunemaker::Twitter::List, :get, "/1.1/lists/list.json", args)
      end
      ...
      #   @param list [Integer, String, Nunemaker::Twitter::List] A Nunemaker::Twitter list ID, slug, URI, or object.
      #   @param options [Hash] A customizable set of options.
      ...
      #     Nunemaker::Twitter.list_timeline('presidents')
      #     Nunemaker::Twitter.list_timeline(8863586)
      ...
      #     Nunemaker::Twitter.list_timeline('sferik', 'presidents')
      #     Nunemaker::Twitter.list_timeline('sferik', 8863586)
      #     Nunemaker::Twitter.list_timeline(7505382, 'presidents')
      #     Nunemaker::Twitter.list_timeline(7505382, 8863586)
      def list_timeline(*args)
        arguments = Nunemaker::Twitter::API::Arguments.new(args)
        merge_list!(arguments.options, arguments.pop)
        merge_owner!(arguments.options, arguments.pop)
        objects_from_response(Nunemaker::Twitter::Tweet, :get, "/1.1/lists/statuses.json", arguments.options)
      end
      ...
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Nunemaker::Twitter::List] The list.
      ...
      #     Nunemaker::Twitter.list_remove_member('presidents', 813286)
      #     Nunemaker::Twitter.list_remove_member('presidents', 'BarackObama')
      #     Nunemaker::Twitter.list_remove_member(8863586, 'BarackObama')
      ...
      #     Nunemaker::Twitter.list_remove_member('sferik', 'presidents', 813286)
      #     Nunemaker::Twitter.list_remove_member('sferik', 'presidents', 'BarackObama')
      #     Nunemaker::Twitter.list_remove_member('sferik', 8863586, 'BarackObama')
      #     Nunemaker::Twitter.list_remove_member(7505382, 'presidents', 813286)
      ...
      #     Nunemaker::Twitter.memberships('sferik')
      #     Nunemaker::Twitter.memberships(7505382)
      def memberships(*args)
        cursor_from_response_with_user(:lists, Nunemaker::Twitter::List, :get, "/1.1/lists/memberships.json", args, :memberships)
      end
      ...
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Nunemaker::Twitter::Cursor] The subscribers of the specified list.
      # @overload list_subscribers(list, options={})
      #   @param list [Integer, String, Nunemaker::Twitter::List] A Nunemaker::Twitter list ID, slug, URI, or object.
      #   @param options [Hash] A customizable set of options.
      #   @option options [Integer] :cursor (-1) Breaks the results into pages. Provide values as returned in the response objects's next_cursor and previous_cursor attributes to page back and forth in the list.
      #   @example Return the subscribers of the authenticated user's "presidents" list
      #     Nunemaker::Twitter.list_subscribers('presidents')
      #     Nunemaker::Twitter.list_subscribers(8863586)
      ...
      #     Nunemaker::Twitter.list_subscribers('sferik', 'presidents')
      #     Nunemaker::Twitter.list_subscribers('sferik', 8863586)
      #     Nunemaker::Twitter.list_subscribers(7505382, 'presidents')
      ...
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Nunemaker::Twitter::List] The specified list.
      # @overload list_subscribe(list, options={})
      #   @param list [Integer, String, Nunemaker::Twitter::List] A Nunemaker::Twitter list ID, slug, URI, or object.
      #   @param options [Hash] A customizable set of options.
      #   @example Subscribe to the authenticated user's "presidents" list
      #     Nunemaker::Twitter.list_subscribe('presidents')
      #     Nunemaker::Twitter.list_subscribe(8863586)
      # @overload list_subscribe(user, list, options={})
      #   @param user [Integer, String, Nunemaker::Twitter::User] A Nunemaker::Twitter user ID, screen name, URI, or object.
      #   @param list [Integer, String, Nunemaker::Twitter::List] A Nunemaker::Twitter list ID, slug, URI, or object.
      #   @param options [Hash] A customizable set of options.
      #   @example Subscribe to @sferik's "presidents" list
      #     Nunemaker::Twitter.list_subscribe('sferik', 'presidents')
      #     Nunemaker::Twitter.list_subscribe('sferik', 8863586)
      #     Nunemaker::Twitter.list_subscribe(7505382, 'presidents')
      ...
      #   @param list [Integer, String, Nunemaker::Twitter::List] A Nunemaker::Twitter list ID, slug, URI, or object.
      #   @param user_to_check [Integer, String, Nunemaker::Twitter::User] A Nunemaker::Twitter user ID, screen name, URI, or object.
      #   @param options [Hash] A customizable set of options.
      #   @example Check if @BarackObama is a subscriber of the authenticated user's "presidents" list
      #     Nunemaker::Twitter.list_subscriber?('presidents', 813286)
      #     Nunemaker::Twitter.list_subscriber?(8863586, 813286)
      #     Nunemaker::Twitter.list_subscriber?('presidents', 'BarackObama')
      ...
      #     Nunemaker::Twitter.list_subscriber?('sferik', 'presidents', 813286)
      #     Nunemaker::Twitter.list_subscriber?('sferik', 8863586, 813286)
      #     Nunemaker::Twitter.list_subscriber?(7505382, 'presidents', 813286)
      #     Nunemaker::Twitter.list_subscriber?('sferik', 'presidents', 'BarackObama')
      # @return [Boolean] true if user is a subscriber of the specified list, otherwise false.
      ...
      #     Nunemaker::Twitter.list_unsubscribe('presidents')
      #     Nunemaker::Twitter.list_unsubscribe(8863586)
      # @overload list_unsubscribe(user, list, options={})
      #   @param user [Integer, String, Nunemaker::Twitter::User] A Nunemaker::Twitter user ID, screen name, URI, or object.
      #   @param list [Integer, String, Nunemaker::Twitter::List] A Nunemaker::Twitter list ID, slug, URI, or object.
      #   @param options [Hash] A customizable set of options.
      #   @example Unsubscribe from @sferik's "presidents" list
      #     Nunemaker::Twitter.list_unsubscribe('sferik', 'presidents')
      #     Nunemaker::Twitter.list_unsubscribe('sferik', 8863586)
      #     Nunemaker::Twitter.list_unsubscribe(7505382, 'presidents')
      ...
      #     Nunemaker::Twitter.list_add_members('presidents', ['BarackObama', 'pengwynn'])
      #     Nunemaker::Twitter.list_add_members('presidents', [813286, 18755393])
      #     Nunemaker::Twitter.list_add_members(8863586, ['BarackObama', 'pengwynn'])
      #     Nunemaker::Twitter.list_add_members(8863586, [813286, 18755393])
      ...
      #     Nunemaker::Twitter.list_add_members('sferik', 'presidents', ['BarackObama', 'pengwynn'])
      #     Nunemaker::Twitter.list_add_members('sferik', 'presidents', [813286, 18755393])
      #     Nunemaker::Twitter.list_add_members(7505382, 'presidents', ['BarackObama', 'pengwynn'])
      #     Nunemaker::Twitter.list_add_members(7505382, 'presidents', [813286, 18755393])
      #     Nunemaker::Twitter.list_add_members(7505382, 8863586, ['BarackObama', 'pengwynn'])
      #     Nunemaker::Twitter.list_add_members(7505382, 8863586, [813286, 18755393])
      ...
      #     Nunemaker::Twitter.list_member?('presidents', 813286)
      #     Nunemaker::Twitter.list_member?(8863586, 'BarackObama')
      ...
      #     Nunemaker::Twitter.list_member?('sferik', 'presidents', 813286)
      #     Nunemaker::Twitter.list_member?('sferik', 8863586, 'BarackObama')
      #     Nunemaker::Twitter.list_member?(7505382, 'presidents', 813286)
      ...
      #     Nunemaker::Twitter.list_members('presidents')
      #     Nunemaker::Twitter.list_members(8863586)
      ...
      #     Nunemaker::Twitter.list_members('sferik', 'presidents')
      #     Nunemaker::Twitter.list_members('sferik', 8863586)
      #     Nunemaker::Twitter.list_members(7505382, 'presidents')
      #     Nunemaker::Twitter.list_members(7505382, 8863586)
      ...
      #     Nunemaker::Twitter.list_add_member('presidents', 813286)
      #     Nunemaker::Twitter.list_add_member(8863586, 813286)
      ...
      #     Nunemaker::Twitter.list_add_member('sferik', 'presidents', 813286)
      #     Nunemaker::Twitter.list_add_member('sferik', 8863586, 813286)
      #     Nunemaker::Twitter.list_add_member(7505382, 'presidents', 813286)
      #     Nunemaker::Twitter.list_add_member(7505382, 8863586, 813286)
      ...
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Nunemaker::Twitter::List] The deleted list.
      # @overload list_destroy(list, options={})
      #   @param list [Integer, String, Nunemaker::Twitter::List] A Nunemaker::Twitter list ID, slug, URI, or object.
      #   @param options [Hash] A customizable set of options.
      #   @example Delete the authenticated user's "presidents" list
      #     Nunemaker::Twitter.list_destroy('presidents')
      #     Nunemaker::Twitter.list_destroy(8863586)
      # @overload list_destroy(user, list, options={})
      #   @param user [Integer, String, Nunemaker::Twitter::User] A Nunemaker::Twitter user ID, screen name, URI, or object.
      #   @param list [Integer, String, Nunemaker::Twitter::List] A Nunemaker::Twitter list ID, slug, URI, or object.
      #   @param options [Hash] A customizable set of options.
      #   @example Delete @sferik's "presidents" list
      #     Nunemaker::Twitter.list_destroy('sferik', 'presidents')
      #     Nunemaker::Twitter.list_destroy('sferik', 8863586)
      #     Nunemaker::Twitter.list_destroy(7505382, 'presidents')
      #     Nunemaker::Twitter.list_destroy(7505382, 8863586)
      ...
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Nunemaker::Twitter::List] The created list.
      ...
      #     Nunemaker::Twitter.list_update('presidents', :description => "Presidents of the United States of America")
      #     Nunemaker::Twitter.list_update(8863586, :description => "Presidents of the United States of America")
      ...
      #     Nunemaker::Twitter.list_update('sferik', 'presidents', :description => "Presidents of the United States of America")
      #     Nunemaker::Twitter.list_update(7505382, 'presidents', :description => "Presidents of the United States of America")
      #     Nunemaker::Twitter.list_update('sferik', 8863586, :description => "Presidents of the United States of America")
      #     Nunemaker::Twitter.list_update(7505382, 8863586, :description => "Presidents of the United States of America")
      ...
      #   Nunemaker::Twitter.list_create('presidents')
      def list_create(name, options={})
        object_from_response(Nunemaker::Twitter::List, :post, "/1.1/lists/create.json", options.merge(:name => name))
      end
      ...
      #     Nunemaker::Twitter.list('presidents')
      #     Nunemaker::Twitter.list(8863586)
      # @overload list(user, list, options={})
      #   @param user [Integer, String, Nunemaker::Twitter::User] A Nunemaker::Twitter user ID, screen name, URI, or object.
      #   @param list [Integer, String, Nunemaker::Twitter::List] A Nunemaker::Twitter list ID, slug, URI, or object.
      #   @param options [Hash] A customizable set of options.
      #   @example Show @sferik's "presidents" list
      #     Nunemaker::Twitter.list('sferik', 'presidents')
      #     Nunemaker::Twitter.list('sferik', 8863586)
      #     Nunemaker::Twitter.list(7505382, 'presidents')
      #     Nunemaker::Twitter.list(7505382, 8863586)
      def list(*args)
      ...
      #     Nunemaker::Twitter.subscriptions
      # @overload subscriptions(user, options={})
      #   @param user [Integer, String, Nunemaker::Twitter::User] A Nunemaker::Twitter user ID, screen name, URI, or object.
      #   @param options [Hash] A customizable set of options.
      #   @option options [Integer] :cursor (-1) Breaks the results into pages. Provide values as returned in the response objects's next_cursor and previous_cursor attributes to page back and forth in the list.
      #   @example List the lists that @sferik follows
      #     Nunemaker::Twitter.subscriptions('sferik')
      #     Nunemaker::Twitter.subscriptions(7505382)
      def subscriptions(*args)
        cursor_from_response_with_user(:lists, Nunemaker::Twitter::List, :get, "/1.1/lists/subscriptions.json", args, :subscriptions)
      end
      ...
      #     Nunemaker::Twitter.list_remove_members('presidents', ['BarackObama', 'pengwynn'])
      #     Nunemaker::Twitter.list_remove_members('presidents', [813286, 18755393])
      #     Nunemaker::Twitter.list_remove_members(8863586, ['BarackObama', 'pengwynn'])
      #     Nunemaker::Twitter.list_remove_members(8863586, [813286, 18755393])
      ...
      #     Nunemaker::Twitter.list_remove_members('sferik', 'presidents', ['BarackObama', 'pengwynn'])
      #     Nunemaker::Twitter.list_remove_members('sferik', 'presidents', [813286, 18755393])
      #     Nunemaker::Twitter.list_remove_members(7505382, 'presidents', ['BarackObama', 'pengwynn'])
      #     Nunemaker::Twitter.list_remove_members(7505382, 'presidents', [813286, 18755393])
      #     Nunemaker::Twitter.list_remove_members(7505382, 8863586, ['BarackObama', 'pengwynn'])
      #     Nunemaker::Twitter.list_remove_members(7505382, 8863586, [813286, 18755393])
      def list_remove_members(*args)
        list_from_response_with_users(:post, "/1.1/lists/members/destroy_all.json", args)
      end

      # Returns the lists owned by the specified Nunemaker::Twitter user
      #
      ...
      #     Nunemaker::Twitter.lists_owend
      # @overload lists_owned(user, options={})
      #   @param user [Integer, String, Nunemaker::Twitter::User] A Nunemaker::Twitter user ID, screen name, URI, or object.
      #   @param options [Hash] A customizable set of options.
      #   @option options [Integer] :count The amount of results to return per page. Defaults to 20. No more than 1000 results will ever be returned in a single page.
      #   @example Return all lists that @sferik owns
      #     Nunemaker::Twitter.lists_owned('sferik')
      #     Nunemaker::Twitter.lists_owned(7505382)
      def lists_owned(*args)
        cursor_from_response_with_user(:lists, Nunemaker::Twitter::List, :get, "/1.1/lists/ownerships.json", args, :lists_owned)
      end
    ...
    private
      ...
      def list_from_response(request_method, path, args)
        ...
        merge_list!(arguments.options, arguments.pop)
        merge_owner!(arguments.options, arguments.pop)
        object_from_response(Nunemaker::Twitter::List, request_method, path, arguments.options)
      end
      ...
      def cursor_from_response_with_list(request_method, path, args, calling_method)
        ...
        merge_list!(arguments.options, arguments.pop)
        merge_owner!(arguments.options, arguments.pop)
        cursor_from_response(:users, Nunemaker::Twitter::User, request_method, path, arguments.options, calling_method)
      end
      ...
      def list_user?(request_method, path, args)
        ...
        true
      rescue Nunemaker::Twitter::Error::NotFound, Nunemaker::Twitter::Error::Forbidden
        false
      end
      ...
      def list_from_response_with_users(request_method, path, args)
        ...
        members.flatten.each_slice(MAX_USERS_PER_REQUEST).threaded_map do |users|
          object_from_response(Nunemaker::Twitter::List, request_method, path, merge_users(arguments.options, users))
        end.last
      end
      ...
      #
      # @param hash [Hash]
      # @param list [Integer, String, URI, Nunemaker::Twitter::List] A Nunemaker::Twitter list ID, slug, URI, or object.
      # @return [Hash]
      ...
      #
      # @param hash [Hash]
      # @param user[Integer, String, Nunemaker::Twitter::User] A Nunemaker::Twitter user ID, screen_name, or object.
      # @return [Hash]
