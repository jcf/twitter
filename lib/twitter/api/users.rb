...
module Nunemaker::Twitter
  module API
    module Users
      ...
      # @return [Nunemaker::Twitter::Settings]
      ...
      # @option options [String] :lang The language which Nunemaker::Twitter should render in for this user. The language must be specified by the appropriate two letter ISO 639-1 representation. Currently supported languages are provided by {https://dev.twitter.com/docs/api/1.1/get/help/languages GET help/languages}.
      # @example Return the settings for the authenticating user.
      #   Nunemaker::Twitter.settings
      def settings(options={})
        request_method = options.size.zero? ? :get : :post
        settings = object_from_response(Nunemaker::Twitter::Settings, request_method, "/1.1/account/settings.json", options)
      ...
      # Returns the requesting user if authentication was successful, otherwise raises {Nunemaker::Twitter::Error::Unauthorized}
      #
      # @see https://dev.twitter.com/docs/api/1.1/get/account/verify_credentials
      # @rate_limited Yes
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Nunemaker::Twitter::User] The authenticated user.
      # @param options [Hash] A customizable set of options.
      # @option options [Boolean, String, Integer] :skip_status Do not include user's Tweets when set to true, 't' or 1.
      # @example Return the requesting user if authentication was successful
      #   Nunemaker::Twitter.verify_credentials
      def verify_credentials(options={})
        object_from_response(Nunemaker::Twitter::User, :get, "/1.1/account/verify_credentials.json", options)
      end
      alias current_user verify_credentials

      # Sets which device Nunemaker::Twitter delivers updates to for the authenticating user
      #
      ...
      #   Nunemaker::Twitter.update_delivery_device('sms')
      def update_delivery_device(device, options={})
        object_from_response(Nunemaker::Twitter::User, :post, "/1.1/account/update_delivery_device.json", options.merge(:device => device))
      end
      ...
      #   Nunemaker::Twitter.update_profile(:name => "Erik Michaels-Ober")
      def update_profile(options={})
        object_from_response(Nunemaker::Twitter::User, :post, "/1.1/account/update_profile.json", options)
      end
      ...
      #   Nunemaker::Twitter.update_profile_background_image(File.new("we_concept_bg2.png"))
      def update_profile_background_image(image, options={})
        object_from_response(Nunemaker::Twitter::User, :post, "/1.1/account/update_profile_background_image.json", options.merge(:image => image))
      end
      ...
      #   Nunemaker::Twitter.update_profile_colors(:profile_background_color => '000000')
      def update_profile_colors(options={})
        object_from_response(Nunemaker::Twitter::User, :post, "/1.1/account/update_profile_colors.json", options)
      end
      ...
      #   Nunemaker::Twitter.update_profile_image(File.new("me.jpeg"))
      def update_profile_image(image, options={})
        object_from_response(Nunemaker::Twitter::User, :post, "/1.1/account/update_profile_image.json", options.merge(:image => image))
      end
      ...
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<Nunemaker::Twitter::User>] User objects that the authenticating user is blocking.
      # @param options [Hash] A customizable set of options.
      # @option options [Integer] :page Specifies the page of results to retrieve.
      # @example Return an array of user objects that the authenticating user is blocking
      #   Nunemaker::Twitter.blocking
      def blocking(options={})
        cursor_from_response(:users, Nunemaker::Twitter::User, :get, "/1.1/blocks/list.json", options, :blocking)
      end
      ...
      #   Nunemaker::Twitter.blocking_ids
      ...
      #   Nunemaker::Twitter.block?('sferik')
      #   Nunemaker::Twitter.block?(7505382)  # Same as above
      ...
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<Nunemaker::Twitter::User>] The blocked users.
      ...
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<Nunemaker::Twitter::User>] The un-blocked users.
      # @overload unblock(*users)
      #   @param users [Enumerable<Integer, String, Nunemaker::Twitter::User>] A collection of Nunemaker::Twitter user IDs, screen names, or objects.
      #   @example Un-block @sferik as the authenticating user
      #     Nunemaker::Twitter.unblock('sferik')
      #     Nunemaker::Twitter.unblock(7505382)  # Same as above
      ...
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<Nunemaker::Twitter::User>] The requested users.
      # @overload users(*users)
      #   @param users [Enumerable<Integer, String, Nunemaker::Twitter::User>] A collection of Nunemaker::Twitter user IDs, screen names, or objects.
      #   @example Return extended information for @sferik and @pengwynn
      #     Nunemaker::Twitter.users('sferik', 'pengwynn')  # Retrieve users with a POST request using screen_names
      #     Nunemaker::Twitter.users(7505382, 14100886)     # Same as above using twitter_ids
      ...
      #   @example Return extended information for @sferik and @pengwynn
      #     Nunemaker::Twitter.users('sferik', 'pengwynn', :method => :get) # Retrieve users with a GET request
      #     Nunemaker::Twitter.users(7505382, 14100886, :method => :get)    # Same as above
      def users(*args)
        arguments = Nunemaker::Twitter::API::Arguments.new(args)
        method = arguments.options.delete(:method) || :post
        arguments.flatten.each_slice(MAX_USERS_PER_REQUEST).threaded_map do |users|
          objects_from_response(Nunemaker::Twitter::User, method, "/1.1/users/lookup.json", merge_users(arguments.options, users))
        end.flatten
      end
      ...
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Nunemaker::Twitter::User] The requested user.
      ...
      #     Nunemaker::Twitter.user('sferik')
      #     Nunemaker::Twitter.user(7505382)  # Same as above
      def user(*args)
        arguments = Nunemaker::Twitter::API::Arguments.new(args)
        if user = arguments.pop
          merge_user!(arguments.options, user)
          object_from_response(Nunemaker::Twitter::User, :get, "/1.1/users/show.json", arguments.options)
        else
      ...
      def user?(user, options={})
        ...
        true
      rescue Nunemaker::Twitter::Error::NotFound
        false
      end
      ...
      #   Nunemaker::Twitter.user_search("Erik Michaels-Ober")
      def user_search(query, options={})
        objects_from_response(Nunemaker::Twitter::User, :get, "/1.1/users/search.json", options.merge(:q => query))
      end
      ...
      #     Nunemaker::Twitter.contributees
      # @overload contributees(user, options={})
      #   @param user [Integer, String, Nunemaker::Twitter::User] A Nunemaker::Twitter user ID, screen name, URI, or object.
      #   @param options [Hash] A customizable set of options.
      #   @option options [Boolean, String, Integer] :skip_status Do not include contributee's Tweets when set to true, 't' or 1.
      #   @example Return users @sferik can contribute to
      #     Nunemaker::Twitter.contributees('sferik')
      #     Nunemaker::Twitter.contributees(7505382)  # Same as above
      ...
      #     Nunemaker::Twitter.contributors
      # @overload contributors(user, options={})
      #   @param user [Integer, String, Nunemaker::Twitter::User] A Nunemaker::Twitter user ID, screen name, URI, or object.
      #   @param options [Hash] A customizable set of options.
      #   @option options [Boolean, String, Integer] :skip_status Do not include contributee's Tweets when set to true, 't' or 1.
      #   @example Return users who can contribute to @sferik's account
      #     Nunemaker::Twitter.contributors('sferik')
      #     Nunemaker::Twitter.contributors(7505382)  # Same as above
      ...
      #   Nunemaker::Twitter.remove_profile_banner
      ...
      # @rate_limited No
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::BadRequest] Error raised when either an image was not provided or the image data could not be processed.
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @raise [Nunemaker::Twitter::Error::UnprocessableEntity] Error raised when the image could not be resized or is too large.
      # @return [nil]
      ...
      #   Nunemaker::Twitter.update_profile_banner(File.new("me.jpeg"))
      ...
      def profile_banner(*args)
        ...
        object_from_response(Nunemaker::Twitter::ProfileBanner, :get, "/1.1/users/profile_banner.json", arguments.options)
      end
