...
module Nunemaker::Twitter
  module API
    module DirectMessages
      ...
      # @return [Array<Nunemaker::Twitter::DirectMessage>] Direct messages sent to the authenticating user.
      ...
      #   Nunemaker::Twitter.direct_messages_received
      def direct_messages_received(options={})
        objects_from_response(Nunemaker::Twitter::DirectMessage, :get, "/1.1/direct_messages.json", options)
      end
      ...
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<Nunemaker::Twitter::DirectMessage>] Direct messages sent by the authenticating user.
      # @param options [Hash] A customizable set of options.
      # @option options [Integer] :since_id Returns results with an ID greater than (that is, more recent than) the specified ID.
      # @option options [Integer] :max_id Returns results with an ID less than (that is, older than) or equal to the specified ID.
      # @option options [Integer] :count Specifies the number of records to retrieve. Must be less than or equal to 200.
      ...
      #   Nunemaker::Twitter.direct_messages_sent
      def direct_messages_sent(options={})
        objects_from_response(Nunemaker::Twitter::DirectMessage, :get, "/1.1/direct_messages/sent.json", options)
      end
      ...
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Nunemaker::Twitter::DirectMessage] The requested messages.
      # @param id [Integer] A direct message ID.
      # @param options [Hash] A customizable set of options.
      # @example Return the direct message with the id 1825786345
      #   Nunemaker::Twitter.direct_message(1825786345)
      def direct_message(id, options={})
        options[:id] = id
        object_from_response(Nunemaker::Twitter::DirectMessage, :get, "/1.1/direct_messages/show.json", options)
      end
      ...
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<Nunemaker::Twitter::DirectMessage>] The requested messages.
      ...
      #   @option options [Integer] :page Specifies the page of results to retrieve.
      #   @example Return the 20 most recent direct messages sent to the authenticating user
      #     Nunemaker::Twitter.direct_messages
      ...
      #   @example Return the direct message with the id 1825786345
      #     Nunemaker::Twitter.direct_messages(1825786345)
      ...
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Array<Nunemaker::Twitter::DirectMessage>] Deleted direct message.
      # @overload direct_message_destroy(*ids)
      #   @param ids [Enumerable<Integer>] A collection of direct message IDs.
      #   @example Destroys the direct message with the ID 1825785544
      #     Nunemaker::Twitter.direct_message_destroy(1825785544)
      # @overload direct_message_destroy(*ids, options)
      #   @param ids [Enumerable<Integer>] A collection of direct message IDs.
      #   @param options [Hash] A customizable set of options.
      def direct_message_destroy(*args)
        threaded_object_from_response(Nunemaker::Twitter::DirectMessage, :post, "/1.1/direct_messages/destroy.json", args)
      end
      ...
      # @authentication Requires user context
      # @raise [Nunemaker::Twitter::Error::Unauthorized] Error raised when supplied user credentials are not valid.
      # @return [Nunemaker::Twitter::DirectMessage] The sent message.
      ...
      #   Nunemaker::Twitter.direct_message_create('sferik', "I'm sending you this message via @gem!")
      #   Nunemaker::Twitter.direct_message_create(7505382, "I'm sending you this message via @gem!")  # Same as above
      def direct_message_create(user, text, options={})
        merge_user!(options, user)
        options[:text] = text
        object_from_response(Nunemaker::Twitter::DirectMessage, :post, "/1.1/direct_messages/new.json", options)
      end
